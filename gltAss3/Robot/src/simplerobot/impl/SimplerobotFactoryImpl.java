...
public class SimplerobotFactoryImpl extends EFactoryImpl implements SimplerobotFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case SimplerobotPackage.EXPRESSION_OPERATOR:
				return createExpressionOperatorFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case SimplerobotPackage.EXPRESSION_OPERATOR:
				return convertExpressionOperatorToString(eDataType, instanceValue);
			case SimplerobotPackage.TEXT:
	 ...
	 * @generated
	 */
	public ExpressionOperator createExpressionOperatorFromString(EDataType eDataType, String initialValue) {
		ExpressionOperator result = ExpressionOperator.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertExpressionOperatorToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
