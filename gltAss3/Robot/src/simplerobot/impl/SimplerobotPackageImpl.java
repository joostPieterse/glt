...
public class SimplerobotPackageImpl extends EPackageImpl implements SimplerobotPackage {
	 ...
	 * @generated
	 */
	private EEnum expressionOperatorEEnum = null;
	 ...
	 * @generated
	 */
	public EEnum getExpressionOperator() {
		return expressionOperatorEEnum;
	}
	...
	public void createPackageContents() {
		...
		expressionOperatorEEnum = createEEnum(EXPRESSION_OPERATOR);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getExpression_Operator(), this.getExpressionOperator(), "operator", null, 0, 1, Expression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(expressionOperatorEEnum, ExpressionOperator.class, "ExpressionOperator");
		addEEnumLiteral(expressionOperatorEEnum, ExpressionOperator.NONE);
		addEEnumLiteral(expressionOperatorEEnum, ExpressionOperator.OR);
		addEEnumLiteral(expressionOperatorEEnum, ExpressionOperator.AND);
