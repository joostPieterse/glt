...
/**
 * This is the item provider adapter for a {@link simplerobot.IfStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfStatementItemProvider extends StatementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplerobotPackage.Literals.IF_STATEMENT__COND);
			childrenFeatures.add(SimplerobotPackage.Literals.IF_STATEMENT__BODY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplerobotPackage.Literals.IF_STATEMENT__COND,
				 SimplerobotFactory.eINSTANCE.createExpression()));

		newChildDescriptors.add
			(createChildParameter
				(SimplerobotPackage.Literals.IF_STATEMENT__BODY,
