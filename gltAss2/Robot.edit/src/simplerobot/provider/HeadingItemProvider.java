...
/**
 * This is the item provider adapter for a {@link simplerobot.Heading} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HeadingItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Heading_wind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Heading_wind_feature", "_UI_Heading_type"),
				 SimplerobotPackage.Literals.HEADING__WIND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Orientation labelValue = ((Heading)object).getWind();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Heading_type") :
			getString("_UI_Heading_type") + " " + label;
	}
